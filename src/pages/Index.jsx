...
const Index = () => {
  return (
    <Container maxW="container.xl" p={{ base: 4, md: 8 }} bg="#1a202c" color="white">
      <VStack spacing={10} align="stretch">
        {/* Hero Section */}
        <Box textAlign="center" py={{ base: 10, md: 20 }} bg="#2d3748" borderRadius="md">
          <Heading as="h1" size={{ base: "xl", md: "2xl" }} mb={4}>Welcome to My Portfolio</Heading>
          <Text fontSize={{ base: "lg", md: "xl" }}>Showcasing my works and projects</Text>
        </Box>

        {/* About Me Section */}
        <Box bg="#2d3748" p={{ base: 5, md: 10 }} borderRadius="md">
          <Heading as="h2" size={{ base: "lg", md: "xl" }} mb={4}>About Me</Heading>
        ...
        {/* Works Section */}
        <Box bg="#2d3748" p={{ base: 5, md: 10 }} borderRadius="md">
          <Heading as="h2" size={{ base: "lg", md: "xl" }} mb={4}>My Works</Heading>
        ...
        {/* Contact Section */}
        <Box textAlign="center" py={{ base: 10, md: 20 }} bg="#2d3748" borderRadius="md">
          <Heading as="h2" size={{ base: "lg", md: "xl" }} mb={4}>Get in Touch</Heading>
          <Text fontSize={{ base: "md", md: "lg" }} mb={4}>Feel free to reach out to me on any of the platforms below:</Text>
